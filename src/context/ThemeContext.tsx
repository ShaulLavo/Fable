...
type ThemeCtx = {
  ...
  xTermTheme: Accessor<{ background: string; foreground: string; cursor: string }>
...
export function ThemeProvider(props: { children: JSX.Element }) {
  const [currentThemeName, setTheme] = makePersisted(createSignal<ThemeKey>('mojo'), {
    name: 'theme'
  })

  const currentThemeSettings = () => themeSettings[currentThemeName() ?? 'mojo'] ?? themeSettings.poimandres
