...
export function AppStateProvider(props: { children: JSX.Element }) {
	...
	const [mainSideBarPosition, setMainSideBarPosition] = makePersisted(
	...
	const [editorPanelSizes, setEditorPanelSizes] = makePersisted(
		createSignal<number[][]>([]),
		{ name: 'editorPanelSizes', storage: dualStorage }
	)

	const [ChatPanelSize, setChatPanelSize] = makePersisted(
	...
	const [lastKnownRightSideBarSize, setLastKnownRightSideBarSize] =
